...
* [![npm](https://img.shields.io/npm/v/xlsx-import)](https://www.npmjs.com/package/xlsx-import) [![Join the chat at https://gitter.im/Siemienik/xlsx-renderer](https://badges.gitter.im/Siemienik/xlsx-renderer.svg)](https://gitter.im/Siemienik/xlsx-renderer?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [XLSX-import](https://github.com/Siemienik/xlsx-import) - just define how data is located inside the spreadsheet file and import an array by write one line.
